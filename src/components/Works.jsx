    ...
    return (
        <div id="projects" className="bg-white w-full  text-black">
            ...
            <div className="ml-0 flex flex-col justify-center items-center gap-[25px] mt-[70px] h-full">
                <div className="bg-red-300 w-[1139px] h-[391px] flex justify-center items-center text-center rounded-2xl shadow-[0px_9px_11px_0px_#a0aec0]"></div>
                <div className="flex items-center justify-center text-center gap-[25px]">
                    <div className="bg-red-400 w-[557px] h-[417px] rounded-2xl shadow-[0px_9px_11px_0px_#a0aec0]"></div>
                    <div className=" bg-red-400 w-[557px] h-[417px] rounded-2xl shadow-[0px_9px_11px_0px_#a0aec0]"></div>
                </div>
                <div className="bg-red-300 w-[1139px] h-[391px] rounded-2xl shadow-[0px_9px_11px_0px_#a0aec0]"></div>
